...
class Chat extends React.Component {
  ...
  render () {
    return (
      <section className={ `chat-box ${ this.state.showStatus ? chat-box-acitve : '' }` }>
        <h2 className="chat-name">站撸科技有限公司</h2>
        <div className="chat-content">
          <div className="chat-content-group" id="message_group">
            <MessageData changeChatStatus={ this.changeChatStatus.bind(this) } ref="webIm" />
          </div>
